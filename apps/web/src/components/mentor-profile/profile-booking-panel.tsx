      ...
      <AppPanel id="booking-panel" className="sticky top-24 overflow-hidden p-5">
        ...
        <div className="relative z-10 space-y-5">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold text-white">Start with the right session</h2>
          ...
          {introVideoUrl ? (
            <a
              href="#intro-video"
              className="inline-flex items-center gap-2 rounded-full border border-brand/20 bg-brand/10 px-3 py-1.5 text-xs font-medium text-brand-lighter transition-colors hover:bg-brand/20"
            >
          ...
          {offers.length > 0 ? (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right">
                        <p className="text-base font-bold text-white">${offer.price}</p>
            ...
            <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
              <p className="text-sm text-slate-300">Custom session pricing available</p>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
            <div className="flex items-start gap-3">
              <CalendarDays className="mt-0.5 h-4 w-4 text-brand-lighter" />
              <div>
          ...
          <div className="space-y-3 border-t border-white/10 pt-5">
            ...
            {!selectedSlot ? (
              <div className="rounded-2xl border border-dashed border-white/10 px-4 py-3 text-center text-xs text-slate-500">
              ...
              <div className="rounded-2xl border border-brand/20 bg-brand/10 px-4 py-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white">Selected slot</p>
